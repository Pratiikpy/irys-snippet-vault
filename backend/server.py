...
# For Vercel deployment, we don't need to serve static files
# Frontend static files are handled by Vercel directly
# Remove static file mounting for serverless deployment